function SalesDashboard() {
    ...
    self.loadPage = function (activeTab) {
        ...
        xhr = $.ajax({
            dataType: "html",
            url: ["views/", url, ".html?ac816019086e4258a2269888ad9386d2"].join(""),
            ...
            load: function(yearOffset) {
                ...
                self.loadData({
                    ...
                    if (data && data.length) {
                        ...
                        if(currentRange.startValue.valueOf() != newStart.valueOf() || currentRange.endValue.valueOf() != newEnd.valueOf()) {
                            dateChanged = true;
...
$(function () {
    ...
    SalesDashboard.setScreenSize().done(function() {
